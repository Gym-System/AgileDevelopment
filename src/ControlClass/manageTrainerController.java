...
public class manageTrainerController {
    ...
    @FXML
    private Label id2_mt;

    @FXML
    private Label id4_mt;
    ...
    @FXML
    void click_add_name_mt(ActionEvent event) {

    }

    @FXML
    void click_add_email_mt(ActionEvent event) {

    }

    @FXML
    void click_add_password_mt(ActionEvent event) {

    }

    @FXML
    void click_name1_mt(ActionEvent event) {

    }

    @FXML
    void click_email1_mt(ActionEvent event) {

    }

    @FXML
    void click_name2_mt(ActionEvent event) {

    }

    @FXML
    void click_name3_mt(ActionEvent event) {

    }

    @FXML
    void click_name4_mt(ActionEvent event) {

    }

    @FXML
    void click_email2_mt(ActionEvent event) {

    }

    @FXML
    void click_email3_mt(ActionEvent event) {

    }

    @FXML
    void click_email4_mt(ActionEvent event) {

    }

    @FXML
    void click_password1_mt(ActionEvent event) {

    }

    @FXML
    void click_password2_mt(ActionEvent event) {

    }

    @FXML
    void click_password3_mt(ActionEvent event) {

    }

    @FXML
    void click_password4_mt(ActionEvent event) {
    ...
    @FXML
    void click_edit_mt(ActionEvent event) {
    ...
    void initialize() {
        ...
        assert id1_mt != null : "fx:id=\"id1_mt\" was not injected: check your FXML file 'manage_trainer.fxml'.";
        ...
        assert button_edit_mt != null : "fx:id=\"button_edit_mt\" was not injected: check your FXML file 'manage_trainer.fxml'.";
        ...
        assert id2_mt != null : "fx:id=\"id2_mt\" was not injected: check your FXML file 'manage_trainer.fxml'.";
        assert id4_mt != null : "fx:id=\"id4_mt\" was not injected: check your FXML file 'manage_trainer.fxml'.";
        ...
        assert id_mt != null : "fx:id=\"id_mt\" was not injected: check your FXML file 'manage_trainer.fxml'.";
